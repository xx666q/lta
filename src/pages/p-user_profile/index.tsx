...
const UserProfilePage: React.FC = () => {
  ...
  const [userProfile, setUserProfile] = useState<UserProfile>({
    ...
    avatar: 'https://s.coze.cn/image/mQuySnXhaPw/'
  });
        ...
        <div className="flex items-center justify-between h-full px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              >
                <img src="https://s.coze.cn/image/Vj-B4GzxwKo/" 
      ...
      <div className="flex pt-16">
        ...
        <aside className={`${styles.glassSidebar} w-64 min-h-screen p-4`}>
          <nav className="space-y-2">
            <Link to="/service-plaza" className={`${styles.menuItem} flex items-center space-x-3 px-4 py-3 rounded-lg text-text-secondary hover:text-secondary transition-colors`}>
            ...
            <Link to="/order-hall" className={`${styles.menuItem} flex items-center space-x-3 px-4 py-3 rounded-lg text-text-secondary hover:text-secondary transition-colors`}>
              <i className="fas fa-hand-holding-box text-lg"></i>
              <span className="font-medium">接单大厅</span>
            </Link>
            <Link to="/order-management" className={`${styles.menuItem} flex items-center space-x-3 px-4 py-3 rounded-lg text-text-secondary hover:text-secondary transition-colors`}>
        ...
        <main className="flex-1 p-6 min-h-screen">
          ...
          <header className="mb-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-accent mb-2">个人中心</h2>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* 资质审核按钮块 */}
              <div 
                className={`${styles.glassCard} p-6 rounded-xl cursor-pointer transition-all hover:transform hover:scale-105`}
                onClick={() => navigate('/qualification-audit')}
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 bg-secondary/20 rounded-full flex items-center justify-center mb-4">
                    <i className="fas fa-certificate text-secondary text-2xl"></i>
                  </div>
                  <h4 className="font-semibold text-accent text-lg mb-2">资质审核</h4>
                  <p className="text-text-light text-sm">查看和管理您的服务商资质，提交审核材料</p>
                </div>
              </div>
              ...
              <div 
                className={`${styles.glassCard} p-6 rounded-xl cursor-pointer transition-all hover:transform hover:scale-105`}
                onClick={() => navigate('/service-publish')}
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 bg-secondary/20 rounded-full flex items-center justify-center mb-4">
                    <i className="fas fa-plus-circle text-secondary text-2xl"></i>
                  </div>
                  <h4 className="font-semibold text-accent text-lg mb-2">服务发布</h4>
                  <p className="text-text-light text-sm">创建和管理您的托管服务，设置价格和服务内容</p>
                </div>
              </div>
              ...
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 bg-secondary/20 rounded-full flex items-center justify-center mb-4">
                    <i className="fas fa-money-bill-wave text-secondary text-2xl"></i>
                  </div>
                  <h4 className="font-semibold text-accent text-lg mb-2">收入提现</h4>
                  <p className="text-text-light text-sm">查看收入明细，申请提现到您的银行卡</p>
                </div>
              </div>
            </div>
          </section>
